...
async function main() {
  ...
  const property1 = await prisma.property.create({
    data: {
      ...
      rentAmount: parseFloat(
        faker.finance.amount({ min: 800, max: 2500, dec: 2 }),
      ),
  ...
  const property2 = await prisma.property.create({
    data: {
      ...
      description: faker.lorem.paragraph(),
      rentAmount: parseFloat(
        faker.finance.amount({ min: 1500, max: 4000, dec: 2 }),
      ),
  ...
  const property3 = await prisma.property.create({
    data: {
      ...
      description: faker.lorem.paragraph(),
      rentAmount: parseFloat(
        faker.finance.amount({ min: 2000, max: 6000, dec: 2 }),
      ),
  ...
  const property4 = await prisma.property.create({
    data: {
      ...
      description: faker.lorem.paragraph(),
      rentAmount: parseFloat(
        faker.finance.amount({ min: 700, max: 2000, dec: 2 }),
      ),
  ...
  const pastStartDate = new Date(
    pastEndDate.getTime() - 365 * 24 * 60 * 60 * 1000,
  ); // Approx 1 an avant
  ...
  await prisma.expense.createMany({
    data: [
      ...
      },
      {
        ...
        amount: parseFloat(
          faker.finance.amount({ min: 200, max: 1500, dec: 2 }),
        ),
      ...
      },
      {
        ...
        amount: parseFloat(
          faker.finance.amount({ min: 100, max: 800, dec: 2 }),
        ),
